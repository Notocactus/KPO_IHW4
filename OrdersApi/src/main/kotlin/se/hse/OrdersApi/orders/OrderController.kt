...
class OrderController (val orderService: OrderService) {
    ...
    @GetMapping("/get/{id}")
    fun getOrderWithId(@PathVariable("id") id: Int) : ResponseEntity<OrderDto> {
...
//                url = "http://localhost:8080/user/userinfo",
                url = "http://auth-service/user/userinfo",
...
//            var order = OrderDto(obj["id"].toString().toInt(), fromStation, toStation, 1)
